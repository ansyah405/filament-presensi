...
class Presensi extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.presensi', ['schedule' => $schedule, 'isInside' => $this->insideRadius, 'attendance' => $attedance]);
    }
    ...
    public function store()
    {
        ...
        if ($schedule) {
            ...
            return redirect('admin/attedances');
            // return redirect()->route('presensi', ['schedule' => $schedule, 'insideRadius' => false]);
        }
    }
}
