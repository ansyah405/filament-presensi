<div>
    <div class="container mx-auto max-w-sm">
        <div class="bg-white p-6 rounded-lg mt-3 shadow-lg">
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div>
                    <h2 class="text-2xl font-bold mb2">Informasi Pegawai</h2>
                ...
                <div>
                    <h2 class="text-2xl font-bold mb2">Presensi</h2>
                    ...
                    @endif
                    <form action="row g-3 mt-3" wire:submit="store" enctype="multipart/form-data">
    ...
    <script>
        ...
        function tagLocation() {
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    if (isWithinRadius(lat, lon, office, radius)) {
        ...
        function isWithinRadius(lat, lon, center, radius) {
            let distance = map.distance([lat, lon], center);
